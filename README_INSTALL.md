...
- Create tables in the orchestrator db (all the initialization parameters are stored in the ``db_with_fc.sql`` file):
    
        mysql -u orchestrator -p -Dorchestrator < db_with_fc.sql
