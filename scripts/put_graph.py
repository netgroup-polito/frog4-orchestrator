...
# nat graph with endpoints in onos_domain
...
# nat graph with endpoints in UN1
nffg_json = '{"forwarding-graph":{"name":"simple-nat-graph","VNFs":[{"name":"nat","ports":[{"name":"data-port","id":"USER:0"},{"name":"data-port","id":"WAN:0"}],"id":"00000001","vnf_template":"isp_nat.json"}],"id":"12","end-points":[{"type":"interface","interface":{"if-name":"eth1"},"id":"00000001","domain":"UN1"},{"type":"interface","interface":{"if-name":"eth2"},"id":"00000002","domain":"UN1"}],"big-switch":{"flow-rules":[{"match":{"port_in":"endpoint:00000002"},"actions":[{"output_to_port":"vnf:00000001:WAN:0"}],"priority":40001,"id":"000000001"},{"match":{"port_in":"vnf:00000001:WAN:0"},"actions":[{"output_to_port":"endpoint:00000002"}],"priority":40001,"id":"000000002"},{"match":{"port_in":"endpoint:00000001"},"actions":[{"output_to_port":"vnf:00000001:USER:0"}],"priority":40001,"id":"000000003"},{"match":{"port_in":"vnf:00000001:USER:0"},"actions":[{"output_to_port":"endpoint:00000001"}],"priority":40001,"id":"000000004"}]}}}'
...
controller = UpperLayerOrchestratorController(user_data=UserData(usr=username, pwd=password))
controller.put(nffg)
print('Job completed')
exit()
